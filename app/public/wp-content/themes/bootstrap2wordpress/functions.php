...
function b2w_assets() {
    ...
    wp_enqueue_style('flaticon', get_theme_file_uri('assets/fonts/flaticon.css'), array(), false, 'all' );
    ...
    wp_enqueue_script('bootstrap2wordpress-js', get_theme_file_uri('assets/js/main.js'), array('jquery','jquery-ui-core','jquery-ui-selectmenu'), '1.0', true );
