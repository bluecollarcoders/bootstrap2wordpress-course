...
new \Kirki\Panel(
    'b2w_theme_option_panel', [
		...
		'description' => esc_html__( 'Use this to cutomize the B2W Theme', 'bootstrap2wordpress' ),
    ]
);
...
new \Kirki\Section (
    ...
    new \Kirki\Field\Textarea(
        ...
        'settings'    => 'footer_copyright',
            ...
            'default'     => 'Copyright Sewnful Digital DBA.',
...
// Section --Pre-Footer CTA
    new \Kirki\Section(
        ...
        [
            ...
            'description' => esc_html__( 'This is a call to action section.', 'bootstrap2wordpress' ),
            'panel'       => 'b2w_theme_option_panel',
            'priority'    => 160,
        ]
    );
    ...
    new \Kirki\Field\Checkbox_Switch(
        [
            ...
            'label'       => esc_html__( 'Call to Action', 'bootstrap2wordpress' ),
...
new \Kirki\Field\Text(
    [
      ...
      'priority'        => 10,
      'partial_refresh' => array(
        'footer_calltoaction_button_text' => array(
