...
class B2W_Link_Widget extends \Elementor\Widget_Base {
    ...
    {
        return [ 'b2w', 'button', 'link', 'highlight'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('Type Your Link Here', 'plugin-b2w'),
                'default' => __('Add your link here ->', 'plugin-b2w'),
            ]
            );
...
// Register widget
\Elementor\Plugin::instance()->widgets_manager->register( new \B2W_Link_Widget() );